...
public class ImageChangeTask {
    ...
    public static void ImageChangeTask(final Context currentContext, final String session_token,final String sendImage) {

        final String UPLOAD_URL ="https://api.allybros.com/superego/upload.php";
        ...
        StringRequest jsonRequest=new StringRequest(Request.Method.POST, UPLOAD_URL, new Response.Listener<String>() {
            @Override
            ...
            protected Map<String,String> getParams() throws AuthFailureError {
                ...
                params.put("new-avatar-file", sendImage);
                return params;
            }
        };
